...
const { 
  getWomanVrData, 
  postWomanVrData 
} = require("../controllers/womanVrDataController");

router.route("/woman-vr").get(getWomanVrData).post(postWomanVrData);
...
// Footer роутер
const { getFooterData, postFooterData } = require("../controllers/footerDataController");
